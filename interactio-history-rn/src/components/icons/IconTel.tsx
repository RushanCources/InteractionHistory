...
function IconTel(props: SvgProps) {
  return (
    <Svg
      viewBox="0 0 100 100"
      {...props}
    >
      <Defs>
        <Path
          d="M0 50a50 50 0 10100 0A50 50 0 100 50"
          id="prefix__a"
          fill="#43b51f"
        />
        <Path
